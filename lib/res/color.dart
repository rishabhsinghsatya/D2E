...
class AppColors {
  static const Color primaryColor = Color.fromARGB(255, 168, 7, 7);
  static const Color backgroundColor = Color(0xffe6e6e6);

  static const Color textColor = Color(0xff000000);
  static const Color primaryTextTextColor = Color(0xffffffff);
  static const Color secondaryTextColor = Color.fromARGB(255, 168, 7, 7);
